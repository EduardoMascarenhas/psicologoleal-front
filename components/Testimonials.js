                ...
                <Swiper {...paramsTwo}>
                  <div className="swiper-slide">
                    <div className="testimonials-one__single">
                      ...
                      <h3 className="testimonials-one__title">Cliente 1</h3>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="testimonials-one__single">
                      ...
                      <h3 className="testimonials-one__title">Cliente 2</h3>
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="testimonials-one__single">
                      ...
                      <h3 className="testimonials-one__title">Cliente 3</h3>
                    </div>
                  </div>
                </Swiper>
